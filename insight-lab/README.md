...
**Ops:** Run all Supabase migrations through `018_storage_member_read.sql` for study features, sharing, tracked sessions, team chat, and member Storage read access. See [supabase/README.md](supabase/README.md).
