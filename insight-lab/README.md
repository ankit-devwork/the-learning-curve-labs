...
**Ops:** Run all Supabase migrations through `023_workspace_typing_presence.sql` for study features, sharing, tracked sessions, team chat, read receipts, typing presence, and member Storage read access. See [supabase/README.md](supabase/README.md).
