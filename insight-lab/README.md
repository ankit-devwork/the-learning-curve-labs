...
**Ops:** Run all Supabase migrations through `022_team_chat_read_state.sql` for study features, sharing, tracked sessions, team chat, read receipts, and member Storage read access. See [supabase/README.md](supabase/README.md).
